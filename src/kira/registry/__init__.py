...
class PluginRegistry:
    ...
    def __init__(self, registry_file: str = "src/kira/registry/plugins_local.yaml") -> None:
...
class AdapterRegistry:
    ...
    def __init__(self, registry_file: str = "src/kira/registry/adapters_local.yaml") -> None:
        self.registry_file = Path(registry_file)
