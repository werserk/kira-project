...
class TestPluginRegistry:
    ...
    def test_is_plugin_enabled(self):
        ...
        assert self.registry.is_plugin_enabled('kira-inbox') == True
        assert self.registry.is_plugin_enabled('kira-calendar') == False
        assert self.registry.is_plugin_enabled('kira-deadlines') == True
        assert self.registry.is_plugin_enabled('nonexistent') == False
...
class TestAdapterRegistry:
    ...
    def test_is_adapter_enabled(self):
        ...
        assert self.registry.is_adapter_enabled('kira-telegram') == True
        assert self.registry.is_adapter_enabled('kira-gcal') == True
        assert self.registry.is_adapter_enabled('kira-filesystem') == False
        assert self.registry.is_adapter_enabled('nonexistent') == False
