...
class TestReducerCommutativity:
    ...
    def test_independent_updates_are_commutative(self):
        ...
        assert state1["tasks"]["task-001"].get("priority") == "high" or state2["tasks"]["task-001"].get("priority") == "high"
        assert state1["tasks"]["task-001"].get("estimate") == "2h" or state2["tasks"]["task-001"].get("estimate") == "2h"
